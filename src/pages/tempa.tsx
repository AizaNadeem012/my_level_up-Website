    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-teal-100 overflow-x-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center pt-20 pb-20 md:pt-32 px-6 overflow-hidden bg-[#fafafa]">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <div className="inline-flex items-center px-4 py-1.5 bg-white border border-slate-200 rounded-full mb-8 shadow-sm animate-bounce-slow">
            ...
            <span className="text-[11px] font-black tracking-[0.2em] text-slate-600 uppercase">
              Top Rated in Hillsborough County
            </span>
          </div>
          ...
          <p className="max-w-3xl mx-auto text-lg md:text-2xl text-slate-500 leading-relaxed mb-12 font-medium">
            Tampa's premier <strong className="text-slate-900">HUD-certified mobile home anchoring</strong> and structural stabilization services.
          </p>
      ...
      <section className="py-20 px-6 bg-teal-50">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg text-slate-700 mb-16 font-medium">
            Proven mobile home anchoring and stabilization with local expertise.
          </p>
          <div className="grid md:grid-cols-3 gap-12">
            {[{ label: "Years Experience", value: `${counts.years}+` },
              { label: "Anchors Installed", value: `${counts.anchors}+` },
              { label: "Safety Rating", value: `${counts.satisfaction}%` }].map((stat,i)=>(
          ...
          {[1,2,3,4].map(i=>(
            <div key={i} className="flex items-center gap-12 mx-6">
              <span className="text-white text-2xl font-black uppercase tracking-tighter flex items-center gap-4">
                <Star className="fill-white w-6 h-6"/> Tampa's Best Anchoring
              </span>
              ...
              <span className="text-white text-2xl font-black uppercase tracking-tighter flex items-center gap-4">
                <MapPin className="fill-white w-6 h-6"/> Serving Hillsborough County
              </span>
              <span className="text-teal-200 text-2xl font-black uppercase tracking-tighter flex items-center gap-4">
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tight mb-12 text-slate-900">
            Tampa Mobile Home Anchoring Services
          </h2>
      ...
      <section className="py-24 px-6 bg-teal-50">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl md:text-5xl font-black uppercase mb-8 tracking-tight">Our Process for Tampa Mobile Home Anchoring</h2>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-lg text-slate-600 mb-12 font-medium">What Tampa homeowners say about our services.</p>
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { name: "Alex K.", review: "Best mobile home anchoring company in Tampa!" },
            ].map((item,i)=>(
      ...
      <section className="py-24 px-6 bg-slate-900 text-white relative">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div className="relative group">
            ...
            <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter mb-8 leading-none relative">
              Why Tampa <br /><span className="text-teal-400">Trusts Us</span>
            </h2>
          ...
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-[3rem] p-12 border border-slate-700 shadow-2xl relative overflow-hidden">
            ...
            <p className="text-slate-400 leading-relaxed mb-8 text-lg">
              Our proprietary anchoring method exceeds standard code, ensuring your mobile home remains level and secure even during Tampa's storm season.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-16 relative z-10">
            <div>
              <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter mb-8 leading-none">
                Ready to <br /><span className="text-teal-600">Start?</span>
              </h2>
              <p className="text-slate-500 text-lg mb-10 font-bold">
                Fast-response foundation experts ready to protect your home.
              </p>
